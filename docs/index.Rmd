...
<div align = "center"><h2>Tables</h2></div>
```{r, echo=FALSE, message=FALSE, results='asis', error=FALSE, warning=FALSE}
library("knitr")
source("../source/Table.R")
kable(head(table_total[1:10,]), format = "markdown")
numob <- nrow(table_total)
```
This table includes all the information we need to start analysing our domains, which is merged from several data sets we found on the Internet. We only display first ten observations in the table as it contains `r numob` observations. 
