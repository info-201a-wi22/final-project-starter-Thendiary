...
# Join three data frames just found, and calculate the total death
#from 2017 to 2019
total_route_death_17_19 <- left_join(left_join(route_death_2017,
                                               route_death_2018,
                                               by = "ROUTENAME"),
                                     route_death_2019,
                                     by = "ROUTENAME") %>%
...
p_rate <- ggplot(data = total_route_death_17_19, aes(x = "", y = rate,
                                                     fill = ROUTENAME)) +
